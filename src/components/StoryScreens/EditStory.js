...
const EditStory = () => {
    ...
    useEffect(() => {
        ...
        const getStoryInfo = async () => {
            setLoading(true)
            try {
                const { data } = await axios.get(`https://blog-app-backend-liard.vercel.app/story/editStory/${slug}`, config)
                setStory(data.data)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.put(`https://blog-app-backend-liard.vercel.app/story/${slug}/edit`, formdata, config)
...
/>
                            ...
                            <div class="currentlyImage">
                                ...
                                <img src={`https://blog-app-backend-liard.vercel.app/storyImages/${previousImage}`} alt="storyImage" />
                            </div>
